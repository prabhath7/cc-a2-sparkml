...
public class SparkMLTraining {
    public static void main(String[] args) throws IOException {
        ...
        Dataset<Row> train = spark.read().format("csv")
                ...
                .load("s3://prabhath-wine/TrainingDataset.csv");
        ...
        Dataset<Row> validation = spark.read().format("csv")
                ...
                .option("header", "true")
                .option("inferSchema", "true")
                .load("s3://prabhath-wine/ValidationDataset.csv");
        ...
        lrModel.save("s3://prabhath-wine/saved_lr_model");
        ...
        dtModel.save("s3://prabhath-wine/saved_dt_model");
