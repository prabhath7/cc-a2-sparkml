...
public class WineQuality {
    public static void main(String[] args) throws IOException {
        ...
        Dataset<Row> trainData = loadAndProcessData(spark, "s3://prabhath-wine/TrainingDataset.csv");
        Dataset<Row> validationData = loadAndProcessData(spark, "s3://prabhath-wine/ValidationDataset.csv");
        ...
        String bestModelPath = "s3://prabhath-wine/best_model";
